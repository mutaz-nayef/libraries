        ...
        <div class=" max-w-6xl  mx-auto movie-info">
            <div class="container mx-auto px-4 py-16 flex flex-col  md:flex-row">
                <div class="mt-20 w-full">
                    <img src="/img/author.png" alt="author" class=" rounded-xl">
                </div>

                <div class="flex flex-col justify-start md:ml-10 ">

                    <div class="hidden lg:flex justify-between pr-10 mb-5">
                        <a id="backTo" href="{{route('authors.index')}}"
                    ...
                    <div class="flex items-center mb-5 space-x-8">
                        ...
                        <h2 class="text-4xl mt-5 font-semibold">{{$author['name']}}</h2>
                    </div>

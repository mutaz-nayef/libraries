                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('cities.update', $city) }}">
                            @csrf
                            {{-- because in form we don't have put method so also you cant use get due to we have same route name url so but method put
                              using laravel blade @ 
                        --}}
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" value="" id="acitve"
                                            name="active">

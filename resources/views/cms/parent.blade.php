        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        @canany(['Read_Admins', 'Create_Admin', 'Update_Admin', 'Delete_Admin'])
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                        ...
                        @endcanany
                        @canany(['Read_Users', 'Create_User', 'Update_User', 'Delete_User'])
                            <li class="nav-item">
                                <a href="#" class="nav-link">
                                    <i class="nav-icon far fa-envelope"></i>
                                    <p>
                        ...
                        @endcanany
                        @canany(['Read_Cties', 'Create_City', 'Update_City', 'Delete_City'])
                        ...
                        @canany(['Create_Role', 'Read_Roles', 'Read_Permissions'])

                            <li class="nav-header">{{ __('cms.roles_permissions') }}</li>
                            @canany(['Read_Roles', 'Create_Role'])
                                <li class="nav-item">
                                    <a href="#" class="nav-link">
                                        <i class="nav-icon far fa-envelope"></i>
                                        <p>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">@yield('main-page-md')</a></li>
